"""
Model Evaluation and Monitoring for GeneFlow ADK Agents
Tracks performance metrics, token usage, latency, and quality
"""
...
class PerformanceMonitor:
    ...
    def __init__(self, storage_path: str = None):
        ...
        # Model pricing (per 1M tokens) - Gemini 2.0 Flash
        self.pricing = {
