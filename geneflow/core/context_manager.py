"""
Advanced Context Management for GeneFlow ADK Agents
...
class ContextWindow:
    """Manages a sliding context window with token limits"""
...
class ContextManager:
    ...
    Maintains analysis results, intermediate findings, and conversation state
    """
