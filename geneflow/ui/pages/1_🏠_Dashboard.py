"""
GeneFlow Dashboard - Home Page
Comprehensive overview of system status, recent analyses, and quick stats
"""
...
with col2:
    if st.button("🔬 View Analysis Results", width="stretch"):
        st.switch_page("pages/3_🔬_Analysis_Results.py")

with col3:
    if st.button("📊 Detailed Statistics", width="stretch"):
